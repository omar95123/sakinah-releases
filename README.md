...
2. نزّل **`app-arm64-v8a-release.apk`** — هذا هو المناسب لكل هاتف أندرويد حديث تقريبًا.
   (إن كان هاتفك قديمًا ورفض التثبيت، نزّل `app-armeabi-v7a-release.apk` بدلًا منه.)
